...
import com.zoo.mvvmkt.databinding.ViewLoadMoreBinding
 ...
 */
class CustomLoadMoreAdapter : TrailingLoadStateAdapter<CustomLoadMoreAdapter.CustomVH>(false) {

    override fun onCreateViewHolder(parent: ViewGroup, loadState: LoadState): CustomVH {
        val viewBinding =
            ViewLoadMoreBinding.inflate(LayoutInflater.from(parent.context), parent, false)
